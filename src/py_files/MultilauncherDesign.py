...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 704, 129))
        ...
        self.blackline2 = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Ignored)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.blackline2.sizePolicy().hasHeightForWidth())
        self.blackline2.setSizePolicy(sizePolicy)
        self.blackline2.setMaximumSize(QtCore.QSize(5, 16777215))
        self.blackline2.setText("")
        self.blackline2.setPixmap(QtGui.QPixmap("Black.jpg"))
        self.blackline2.setObjectName("blackline2")
        self.gridLayout_5.addWidget(self.blackline2, 2, 2, 1, 1)
        self.blackline = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.blackline.sizePolicy().hasHeightForWidth())
        self.blackline.setSizePolicy(sizePolicy)
        self.blackline.setMaximumSize(QtCore.QSize(16777215, 5))
        self.blackline.setMidLineWidth(0)
        self.blackline.setText("")
        self.blackline.setPixmap(QtGui.QPixmap("Black.jpg"))
        self.blackline.setObjectName("blackline")
        self.gridLayout_5.addWidget(self.blackline, 1, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.commandFileLable, 2, 1, 1, 1)
