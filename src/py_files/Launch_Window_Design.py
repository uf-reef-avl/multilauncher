...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.buttonStopThread, 2, 1, 1, 1)
        self.lineDebugCommand = QtWidgets.QLineEdit(Dialog)
        self.lineDebugCommand.setObjectName("lineDebugCommand")
        self.gridLayout.addWidget(self.lineDebugCommand, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.debugLabel, 1, 0, 1, 1)
