...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.repoTable.setColumnCount(5)
        ...
        self.repoTable.horizontalHeader().setDefaultSectionSize(180)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Select which branches you want to pull on the remote machines."))
